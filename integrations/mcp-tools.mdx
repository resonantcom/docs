...
Resonant exposes 11 tools through its MCP server. Each tool is callable by any MCP-compatible AI assistant. See the [MCP setup guide](/integrations/mcp) for connection instructions.
