---
title: Introduction
description: Resonant is a local-first voice workspace for macOS and Windows. Dictate, record meetings, and query your voice history — all processed on your device.
---
...
<CardGroup cols={2}>
  ...
  <Card title="Features" icon="sparkles" href="/features/dictation">
    Explore dictation, meetings, journal, and more.
  </Card>
</CardGroup>
